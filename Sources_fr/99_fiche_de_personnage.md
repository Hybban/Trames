...
| Nom du Trait | Max | État actuel *(pendant la scène)* |
|---|---|---|
| **Archétype :** __________________ | d12 | `☐ d12` `☐ d10` `☐ d8` `☐ d6` |
...
| Palier | Cases | Malus mécanique |
|---|---|---|
| **Fil Effiloché** *(Blessures légères)* | `☐ ☐ ☐` | Aucun |
| **Fil Tendu** *(Blessures sérieuses)* | `☐ ☐ ☐` | +1d4 à tous les jets *(Fils Emmêlés)* |
| **Fil au Bord de la Rupture** *(Blessures mortelles)* | `☐ ☐ ☐` | +3d4 à tous les jets *(Fils Emmêlés)* |

---

## RESSOURCES *(1 à 5)*

> Une ressource peut rendre une action automatiquement réussie si la situation s'y prête.
> Lors d'un jet, une ressource permet de doubler l'un des dés de trait lancés.
> Une ressource peut devenir inaccessible suite à un échec ou un accroc.
