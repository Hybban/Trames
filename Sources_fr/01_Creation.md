...
La création des personnages est une étape importante du jeu. Elle permet de définir les personnages qui seront joués par les joueuses et de déterminer leurs caractéristiques physiques, mentales, sociales, et morales. Les personnages sont définis par un ensemble de traits libres qui peuvent évoluer au fil de l'histoire. 

Les personnages doivent faire face à des situations exceptionnelles et sont le centre autour desquelles l'histoire va se construire. Les situations peuvent être variées et peuvent se dérouler dans n'importe quel genre et univers imaginables. Il faut bien sûr adapter les personnages à l'univers choisi, univers qui peut être co-construit.
...
Cette promesse n'est pas un contrat rigide. Elle peut évoluer au fil des sessions. Mais elle sert de boussole quand les choix narratifs sont difficiles, et de rappel, en fin de campagne, de ce que les Moires avaient tissé depuis le début. Ceci se fait, bien entendu, en tenant compte de la sécurité émotionnelle de toutes les joueuses autour de la table.

## 2. Définir les Traits
Un héros est composé de **huit traits** maximum au départ. Le nombre de traits du personnage pourra augmenter (et même diminuer dans certaines circonstances) au fur et à mesure de ses aventures.Bien que vous puissiez les choisir librement, privilégiez des formulations courtes et précises sans être trop restrictives. Un trait peut aussi bien être un atout qu'une source de complication narrative (ex: "Curieux", "Dévoué à sa famille").
...
La valeur donnée à ce trait est sa valeur maximale actuelle. Cette valeur maximale pourra évoluer au fur et à mesure des aventures et des tests. En cours de partie, la valeur du trait fluctuera entre sa valeur maximale et d6.

> **Note sur la création fluide :** Vous n'êtes pas obligé de définir vos huit traits immédiatement. Vous pouvez en laisser certains "vides" et les nommer en cours de partie pour répondre à un besoin narratif, en piochant dans les dés restants de votre réserve initiale. Si vous n'avez pas utilisé un de vos d8 et un de vos d6 à la création, ce sont les deux valeurs qui vous restent pour nommer de nouveaux traits plus tard.
