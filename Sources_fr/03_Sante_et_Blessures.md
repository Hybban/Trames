...
Les règles présentées ici suivent le mode de jeu **Fil de Laine**, le mode de jeu par défaut. A la fin de ce chapitre, vous avez une table qui adapte les paliers de dégâts selon le mode de jeu choisi.
...
* **Réussite avec prix (5 – 8) :** Le personnage subit potentiellement des dégâts. Cela peut être compensé par des complications narratives à la place des dégâts, ou une perte de ressource. Si aucune complication narrative n'est souhaitée, alors le personnage subit des **fils effilochés**. Ils peuvent être **tendus** si la situation s'y prête.
* **Échec (1 – 4) :** Le personnage est pleinement touché. Les conséquences sont **tendues** ou **à la limite**. 
...
* **Récupération Légère :** Toutes les cases de blessures **effilochées** sont effacées automatiquement à la **fin de la scène**. Si le personnage n'a subit que des blessures **effilochées**, il récupére aussi tous ses traits au niveau maximum.
* **Récupération Profonde :** Pour effacer des cases de blessures **tendues** ou **à la limite**, une simple pause ne suffit pas. Le héros doit s'engager dans une scène de repos dédiée et justifier d'un soutien adéquat (soins médicaux, thérapie, sanctuaire, utilisation de ressource, ou aide d'un allié spécialisé).
