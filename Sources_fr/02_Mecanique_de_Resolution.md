...
* Un trait ne peut pas normalement descendre en dessous du d6. 

Si vous n'avez pas le choix que de diminuer à un moment un trait qui est déjà au minimum, ce trait ne pourra plus être utilisé pour le reste de la scène. 

**Note :** Attention, plus vous mobilisez de traits, plus vous augmentez vos chances de succès, mais plus vous vous exposez à des complications.

> **La Règle du "1" (L'accroc) :** Peu importe le résultat final, chaque "1" obtenu sur l'ensemble des dés lancés crée un accroc dans la trame. Une complication surgit : diminution d'un cran sur un dé supplémentaire, ressource qui devient inaccessible, ou contrainte narrative. Les Moires ont tiré sur un fil de votre destinée.

## 3. Les Manœuvres Fondamentales
...
- **9-12 :** La lecture est juste et nette. La Meneuse doit répondre honnêtement à une question directe sur la situation, un personnage, ou ses intentions.
...
| **5 – 8** | Diminue un de ses traits d'un cran. | **Une contributrice diminue le trait qu'elle a offert d'un cran.** En plus de la lanceuse principale, bien sûr. |
