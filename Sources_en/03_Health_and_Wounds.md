...
The rules presented here follow the **Thread of Wool** game mode, the default game mode. At the end of this chapter, you’ll find a table that adapts the damage tiers based on the chosen game mode.

## 1. Damage Tiers
Damage is cumulative based on its severity. As long as the damage is minor, there is no mechanical impact, but it acts as a buffer before more critical conditions.
...
> **The "Tangled Threads" Effect:** The d4 added by injuries are damaged threads that get tangled up in your action. They cannot exceed 4 and therefore offer no chance of success, not even partial. Their sole effect is to increase the probability of a mishap, triggering complications and resource depletion. Mechanically, they represent what pain and fatigue do to a frame: they clutter it without strengthening it.

--pb--

## 2. Taking Damage
Damage is often taken based on the result of a dice roll: 

* **Total Success (9–12):** The character avoids the worst. There is no damage, or only minor damage in some very critical cases.
* **Success with a Price (5–8):** The character potentially takes damage. This can be offset by narrative complications instead of damage, or a loss of resources. If no narrative complications are desired, then the character suffers **frayed threads**. These can be **strained** if the situation warrants it.
* **Failure (1–4):** The character is fully affected. The consequences are **strained** or **at the limit**. 

Depending on the context, this may involve physical, psychological, or social damage.
...
| **Silken Thread** | 5 | 4 | 3 | Immediate (post-conflict) | Simple rest scene |
| **Golden Thread** | 6 | 6 | 4 | Immediate (post-roll) | Automatic (end of scene) |